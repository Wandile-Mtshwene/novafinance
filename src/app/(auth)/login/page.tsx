...
import { Eye, EyeOff, Loader2, TrendingUp, FileText, PieChart, ShieldCheck } from "lucide-react";
...
const DEMO = { email: "demo@novafinance.app", password: "demo1234" };

const FEATURES = [
  { icon: TrendingUp, text: "Track revenue and expenses in real time" },
  { icon: FileText, text: "Create and send professional invoices instantly" },
  { icon: PieChart, text: "Understand your margins, cash flow, and runway" },
  { icon: ShieldCheck, text: "Stay on top of SARS, VAT, and PAYE deadlines" },
];
    ...
    <div className="min-h-screen flex bg-[var(--nova-surface)]">
      ...
      <div className="hidden md:flex md:w-[45%] relative flex-col justify-between p-10 overflow-hidden bg-[var(--nova-deep)]">
        ...
        <div className="relative space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-[var(--nova-text)] leading-snug">
              Financial intelligence<br />for growing businesses.
            </h2>
            <p className="mt-3 text-sm text-[var(--nova-muted)] leading-relaxed max-w-xs">
              Accounting, invoicing, cash flow, and compliance, all in one beautifully designed platform built for South African SMEs.
            </p>
          </div>
        ...
        <p className="relative text-[11px] text-[var(--nova-dim)]">
          &copy; {new Date().getFullYear()} NovaFinance. All rights reserved.
        </p>
      </div>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-[var(--nova-muted)]">
              Sign in to your NovaFinance account
            </p>
          </div>
